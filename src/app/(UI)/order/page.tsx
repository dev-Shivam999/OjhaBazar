                ...
                <ul>
                    {orders.map((addr: any) => (
                        <li key={addr.address.id} className="border p-3 my-2 rounded-md">
                            ...
                            {addr.orderItems.map((product: any) => (
                                <div key={product.id} className="max-w-4xl mx-auto mt-10 p-6 border rounded-lg shadow-lg text-black bg-white">
